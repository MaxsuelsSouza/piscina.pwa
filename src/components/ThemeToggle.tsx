...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="inline-flex items-center justify-center w-10 h-10 p-2 rounded-full bg-gray-200 hover:bg-gray-300 border border-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-600 transition-all"
